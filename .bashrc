...
export NLTK_DATA=/home/rich/nltk_data
...
# set missing dir colors as per https://forum.manjaro.org/t/dircolors-not-effective-anymore-in-terminator-after-last-update-in-xfce/16113/2
...
#To change look and feel, move the appropriate section to the top java options setting:
...
# export _JAVA_OPTIONS='-Dswing.systemlaf=com.sun.java.swing.plaf.motif.MotifLookAndFeel'
# export _JAVA_OPTIONS='-Dswing.systemlaf=javax.swing.plaf.metal.MetalLookAndFeel'
# export _JAVA_OPTIONS='-Dswing.systemlaf=javax.swing.plaf.nimbus.NimbusLookAndFeel'
# this is an extra look for play that does not seem to be installed properly:
# export _JAVA_OPTIONS='-D-Dswing.systemlaf=net.sourceforge.napkinlaf.NapkinLookAndFeel'
...
# disable wine file association hijacking
...
__conda_setup="$('/home/rich/bin/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/rich/bin/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/rich/bin/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/rich/bin/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
